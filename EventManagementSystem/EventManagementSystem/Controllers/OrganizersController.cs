...
namespace EventManagementSystem.Controllers
{
    ...
    public class OrganizersController : ControllerBase
    {
        ...
        public OrganizersController(EventManagementContext context)
        {
            _context = context;
        }
        ...
        [HttpPost("login")]
        public async Task<ActionResult> LoginOrganizer([FromBody] LoginModel model)
        {
            var organizer = await _context.Organizers
                .FirstOrDefaultAsync(o => o.Email == model.Email && o.PasswordHash == model.PasswordHash);
        ...
        public async Task<ActionResult<Organizer>> PostOrganizer(Organizer organizer)
        {
          if (_context.Organizers == null)
          {
              return Problem("Entity set 'EventManagementContext.Organizers'  is null.");
          }
